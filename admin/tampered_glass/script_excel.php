<!doctype html>
    <?php
            ...
            header("Content-Disposition: attachment; filename=Laporan Stok Tampered Handphone Inventaris Gadget.xls"); 
      ?>
<html lang="en">
  <head>
    <meta charset="utf-8">
  ...
  <body>
    <p align="center" style="font-weight:bold;font-size:16pt">LAPORAN STOK TAMPERED GLASS PENJUALAN</p>
     ...
     <Table border="1" align="center" class="table table-dark table-striped">
       <thead>
         <tr align="center">
           ...
           <th width="200">Merek Tampered Glass</th>
           <th width="200">Jumlah Tampered Glass</th>
           <th width="200">Harga Tampered Glass</th>
           <th width="200">Jenis Tampered Glass</th>
